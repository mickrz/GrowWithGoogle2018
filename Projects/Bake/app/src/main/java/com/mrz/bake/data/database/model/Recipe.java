...
public class Recipe implements Parcelable
{
    ...
    protected Recipe(Parcel in) {
        ...
        in.readList(this.ingredients, (com.mrz.bake.data.database.model.Ingredient.class.getClassLoader()));
        this.steps = new ArrayList<>();
        in.readList(this.steps, (com.mrz.bake.data.database.model.Step.class.getClassLoader()));
